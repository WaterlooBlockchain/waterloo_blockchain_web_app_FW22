<div>
    ...
    <div class="header_flex">
        ...
        <div class="flex_row"><a href='/events' class="flex_text">EVENTS</a></div>
        <div class="flex_row_icon"><a href='/' class="flex_text"><img class="icon" src="{{asset('images/uw_blockchain.png')}}" width={63} height={71}></img></a></div>
