...
export default function Sponser() {
    ...
    return (
        <div className={styles.container}>
            ...
            <a href='/waterlooblockchain_2023.pdf' download><Image src='/sponsership_package.png' width={105} height={138} layout={'responsive'}></Image></a>
            </div>
            <div className={styles.content}>
                ...
                <a href='/waterlooblockchain_2023.pdf' className={styles.download} download>Download our sponsorship package</a>
            </div>
        </div>
    )
}